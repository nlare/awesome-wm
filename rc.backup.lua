...
function update_amd()
    return { awful.util.pread(os.getenv("HOME") .. '/_scripts/GPU/amd_temp.sh')}
end
...
function update_nvidia()
    return { awful.util.pread('/home/nlare/_scripts/GPU/nvidia_temp.sh')}
end
...
--        end
    ...
    left_graph:add(amdgputemp)
    left_graph:add(nvidiagputemp)
